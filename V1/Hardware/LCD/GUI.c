...
/*****************************************************************************
 * @name       :void Gui_DrawCross(uint16_t x,uint16_t y,uint16_t color)
 * @date       :2024-05-15 
 * @function   :Display a 16-bit BMP image
 * @parameters :x:the bebinning x coordinate of the BMP image
                y:the bebinning y coordinate of the BMP image
 ...
 * @retvalue   :None
******************************************************************************/ 
void Gui_DrawCross(uint16_t x,uint16_t y,uint16_t color)
{
	LCD_DrawLine(x-15,y,x+15,y);
	LCD_DrawLine(x,y-15,x,y+15);
}